...
const CTABanner = () => {
  ...
  // Smooth spring-based mouse position (-1 to 1)
  const sx = useSpring(mx, { stiffness: 60, damping: 20, mass: 0.6 });
  const sy = useSpring(my, { stiffness: 60, damping: 20, mass: 0.6 });

  // Parallax translations for layers (subtle, premium)
    ...
    <section className="relative py-20 md:py-28">
      <div className="container">
        <Reveal>
          ...
          >
            {/* Background coding video — continuous loop with slow flowing drift */}
            <motion.div
              aria-hidden
            ...
            {/* Light glass sheen — keeps code clearly visible */}
            <motion.div
              aria-hidden
              className="absolute inset-0"
              style={{
            ...
            {/* Soft vignette for text legibility (very light) */}
            <div
              aria-hidden
              className="absolute inset-0"
              style={{
